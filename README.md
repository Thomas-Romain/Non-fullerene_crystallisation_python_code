...
This code heavily relies on sif_parser to read off the .sif files as 2 columns in an array, the sif_parser.utils.parse(filename) function. It can be obtained: https://pypi.org/project/sif-parser/
